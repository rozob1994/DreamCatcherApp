...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionTenBinding;
...
public class QuestionTenFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionTenTitle.setTypeface(fontTitle);
        binding.questionTen.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionTenTitle.setTextSize(30f);
        binding.questionTen.setTextSize(25f);
