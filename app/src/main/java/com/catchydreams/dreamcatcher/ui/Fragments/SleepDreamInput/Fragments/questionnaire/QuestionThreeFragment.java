...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionThreeBinding;
 ...
 */
public class QuestionThreeFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionThreeTitle.setTypeface(fontTitle);
        binding.questionThree.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionThreeTitle.setTextSize(30f);
        binding.questionThree.setTextSize(25f);
