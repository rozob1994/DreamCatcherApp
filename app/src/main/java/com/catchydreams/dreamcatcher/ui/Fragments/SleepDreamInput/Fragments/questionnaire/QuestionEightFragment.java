...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionEightBinding;
...
public class QuestionEightFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionEightTitle.setTypeface(fontTitle);
        binding.questionEight.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionEightTitle.setTextSize(30f);
        binding.questionEight.setTextSize(25f);
