...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionTwoBinding;
 ...
 */
public class QuestionTwoFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionTwoTitle.setTypeface(fontTitle);
        binding.questionTwo.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionTwoTitle.setTextSize(30f);
        binding.questionTwo.setTextSize(25f);
