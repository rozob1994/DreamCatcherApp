...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionSixBinding;
 ...
 */
public class QuestionSixFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionSixTitle.setTypeface(fontTitle);
        binding.questionSix.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionSixTitle.setTextSize(30f);
        binding.questionSix.setTextSize(25f);
