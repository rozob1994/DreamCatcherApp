...
import com.catchydreams.dreamcatcher.databinding.FragmentQuestionTwelveBinding;
 ...
 */
public class QuestionTwelveFragment extends Fragment implements IQuestionnaire {
    ...
    public void setPersianTypeFace() {
        ...
        binding.questionTwelveTitle.setTypeface(fontTitle);
        binding.questionTwelve.setTypeface(fontSubTitle);
    ...
    public void setPersianFontSize() {
        binding.questionTwelveTitle.setTextSize(30f);
        binding.questionTwelve.setTextSize(25f);
