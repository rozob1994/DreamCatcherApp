...
public interface IPostService {
    @FormUrlEncoded
    @POST("postpost.php")
    Call<ResponseBody> savePost(@Nullable @Field("uid") int uid,
                                ...
                                @Nullable @Field("dreamPeopleExist") boolean dreamPeopleExist,
                                @Nullable @Field("dreamPeopleImpression") int dreamPeopleImpression,
                                @Nullable @Field("dreamSound") boolean dreamSound,
                                @Nullable @Field("dreamMusical") boolean dreamMusical,
                                @Nullable @Field("dreamFalseAwake") boolean dreamFalseAwake,
                                @Nullable @Field("dreamGrayScale") boolean dreamGrayScale,
                                @Nullable @Field("dreamDailyRelated") int dreamDailyRelated,
                                @Nullable @Field("dreamExperience") int dreamExperience,
                                @Nullable @Field("dreamLucid") boolean dreamLucid,
